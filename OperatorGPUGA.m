function Offspring = OperatorGPUGA(Parent, Lower, Upper, proC, disC, proM, disM)
% GA operator using GPU acceleration
    ...
    Site = gpuArray.rand(2 * N, D) < proM / D;
    mu = gpuArray.rand(2 * N, D);
